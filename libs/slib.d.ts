...
declare namespace SLIB {
    ...
    class HttpGameClient extends GameClient {
         ...
         */
        request(action: any, data: any, callback: (data: ResponseData) => void, { modal, downloadProgress, uploadProgress, errorCallback }?: {
            modal?: boolean;
        ...
        protected requestFromData(action: any, requestData: RequestData, callback: (data: ResponseData) => void, { modal, downloadProgress, uploadProgress, errorCallback }?: {
            modal?: boolean;
            downloadProgress?: (loaded: number, total: number) => void;
            uploadProgress?: (loaded: number, total: number) => void;
            errorCallback?: (error: any, retry: () => void) => void;
...
declare namespace SLIB {
    ...
    class SocketGameClient extends GameClient {
        ...
        protected _serverCallbackList: Array<RequestInfo>;
        ...
        request(action: string, data: any, callback: (data: ResponseData) => void, modal?: boolean): void;
        close(): void;
    }
}
