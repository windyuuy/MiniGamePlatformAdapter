...
declare namespace BK {
    ...
    export class Script {
        ...
        /**
         * 获取资源绝对路径
         * @param resPath 以GameRes://开头的路径
         * @param sufix 资源后缀
         * @return 资源绝对路径
         */
        static pathForResource(resPath: string, sufix: string): string;
    ...
    export class Node extends Object {
         ...
         * 添加节点
          ...
          * @memberof Node
          */
        addChild(node: Node | any, index?: number): void;
    ...
    export class SkeletonAnimation extends Node {
         ...
         * @param {(animName:string,trackId:number,sk:BK.SkeletonAnimation)=>void} startCallBack 
         * @param {(animName:string,trackId:number,sk:BK.SkeletonAnimation)=>void} completeCallBack 
         * @param {(animName:string,trackId:number,sk:BK.SkeletonAnimation)=>void} endCallBack 
         * 
        ...
        constructor(atlasPath: string,
            jsonPath: string,
            timeScale: number,
            startCallBack: (animName: string, trackId: number, sk: BK.SkeletonAnimation) => void,
            completeCallBack: (animName: string, trackId: number, sk: BK.SkeletonAnimation) => void,
            endCallBack: (animName: string, trackId: number, sk: BK.SkeletonAnimation) => void);
    ...
    export class FileUtil {
        ...
        static upload(buff, extInfo, callback): void;

        static uploadFromFile(path, callback): void;
    ...
    export class Texture {
        ...
        /**
         * 通过一段buffer来构造纹理
         * 注意：此buffer必须为已经编码的png数据
         * @param buff 
         * @param width 图片的宽
         * @param height 图片的常
         */
        constructor(buff: BK.Buffer, width: number, height: number);

        /**
         * 
         * @param buff 
         */
        static createTextureWithBuffer(buff: BK.Buffer);
    ...
    export class Text extends Sprite {
        constructor(style: BK.TextStyle, content: string);
        content: string;   //正文
        fontSize: number;  //字体大小
        fontColor: number; //字体颜色
        maxSize: BK.Size;  //最大大小
        bold: number;      //是否粗体
        italic: number;    //是否斜体
        horizontalAlign: number; //左右居中
        strokeColor: number;  //描边颜色
        strokeSize: number;   //描边大小
    ...
    export namespace Misc {
         ...
         * 
         */
        export function handleDNSQueryResult();
    ...
    export interface IWebSocket {
         ...
         * @param {IWebSocket} ws
         */
        onClose: (IWebSocket, event: any) => void;

        /**
         * 当websocket连接发生错误时调用
         * @param {IWebSocket} ws
         */
        onError: (IWebSocket, event: any) => void;
    ...
    class RoomUserDataArr extends Array {
        frameSeq: number;
    }
    ...
    export const enum RoomEvent {
        Create = 1000,    //创建房间
        SelfJoin = 1001,  //自己加入房间
        OtherJoin = 1002, //其他人加入房间
        SelfLeave = 1003, //自己离开
        OtherLeave = 1004,//他人离开
        StartGame = 1005, //开始游戏
        PushFrame = 1006, //下行帧
     ...
     */
    export class AnimatedSprite extends BK.Sprite {
        delayUnits: number; //设置每一帧持续时间，以秒为单位。默认1/30秒
        /**
         * 
         * @param textureInfoArr 
         */
        constructor(textureInfoArr: Array<BK.SheetTextureInfo>);
        play(beginFrameIdx?: number, repeatCount?: number): void;
        stop(frameIdx?: number): void;
        ...
        updateCallback(): void;
        setCompleteCallback(completeCallback: (animatedSprite: AnimatedSprite, count: number) => void): void;
        setEndCallback(completeCallback: (animatedSprite: AnimatedSprite, count: number) => void): void;
    }
    ...
    export class Sprite9 extends Sprite {
        /**
         ...
         * @memberof Sprite9
         */
        constructor(texWidth: number, texHeight: number, texture: BK.Texture, grid: Sprite9Grid, offset: Sprite9Offset, rotated?: boolean);
    }
    ...
    export namespace Render {
        ...
        export function renderToTexture(node: BK.Node, texture: BK.RenderTexture): void;
    }
    ...
    export class TextNode extends Sprite {
        /**
         ...
         * @param content 
         */
        updateText(style: TextStyle, content: string);

        measureTextSize(style: BK.TextStyle, content: string);

        static measureTextSize(style: BK.TextStyle, content: string);
    }
    ...
    export class Audio {
        ...
        static pauseAllBackground();
        static resumeAllBackground()
    }
    ...
    export class HttpUtil {
         ...
         * @param refer 
         */
        setHttpReferer(refer: string);

        /**
         * 设置cookies
         * @param cookies 
         */
        setHttpCookie(cookies: string);
        ...
        /**
         * 设置兼容模式
         * 设置是否在header中兼容PostBody。默认true
         * @param isCompatible
         */
        setBodyCompatible(isCompatible: boolean);

        /**
         * 设置post请求数据
         * @param postDataString 
         */
        setHttpPostData(postDataString: string);
         ...
         * @param code 
         */
        requestAsync(callback: (res: BK.Buffer, code: number) => void);
    }

    //蒙版节点
    export class ClipNode extends Node {
        constructor(sp: BK.Sprite);
        inverted: boolean;
        alphaThreshold: number;
    }

    //蒙版
    export class ClipMask extends Node {
        constructor(sp: BK.Sprite, inverted: boolean, alphaThreshold: number);
        inverted: boolean;
        alphaThreshold: number;
    }
    ...
    const enum NetworkChangeState
    {
        ...
        WifiToCellular = 6 //wifi网络到234G：6
    }
    ...
    export class Emitter {
        ...
        private __emit_get;
        constructor();
        privatEmitterget(event: any): any;
        private __emit_put(event, desc);
        private __emit_exists(event, target);
        dispose(): void;
        on(event: any, target: any, callback: (cbData: EmitCBData) => void, once?: boolean): void;
        off(event: any, target: any): void;
        offAll(target: any): void;
        emitAll(event: any, extras?: any): void;
...
//预留的AMD与CMD模块
declare var exports = undefined;
declare var module = undefined;
declare var define = undefined;
//ticker函数
