...
namespace AppShare.PayFlow.BaiduAppPayFlow {
    ...
    export class BaiduPayRequests extends GDK.PayFlow.PayRequestsNormal {
	...
	/**
	 * BaiduApp 渠道
     * - 针对 BaiduApp 渠道支付在安卓平台特有的一些问题等进行定制
	 */
    export class PayFlow extends GDK.PayFlow.PayInApp.PayFlow {
        payFlowName = "BaiduAppPayFlow"

        /** 重载支付网络请求 */
        payNetClient = new BaiduPayRequests()
    ...
    payFlowManager.registerPayFlow("BaiduAppPayFlow", PayFlow)
}
