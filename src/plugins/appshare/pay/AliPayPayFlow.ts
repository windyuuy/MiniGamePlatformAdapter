...
namespace AppShare.PayFlow.AliPayPayFlow {
    ...
    export class AliPayPayRequests extends GDK.PayFlow.PayRequestsNormal {
    ...
    export class PayFlow extends GDK.PayFlow.PayInAppWithAutoMakeup.PayFlow {
        payFlowName = "AliPayPayFlow"

        /** 重载支付网络请求 */
        payNetClient = new AliPayPayRequests()
    ...
    payFlowManager.registerPayFlow("AliPayPayFlow", PayFlow)
}
