...
namespace AppShare.PayFlow.OppoAppFlow {
    ...
    export class OppoPayRequests extends GDK.PayFlow.PayRequestsNormal {
    ...
    export class PayFlow extends GDK.PayFlow.PayInApp.PayFlow {
        payFlowName = "OppoAppFlow"

        /** 重载支付网络请求 */
        payNetClient = new OppoPayRequests()
