...
namespace AppShare.PayFlow.AliGameAppPayFlow {
    ...
    export class AliGamePayRequests extends GDK.PayFlow.PayRequestsNormal {
    ...
    export class PayFlow extends GDK.PayFlow.PayInAppWithAutoMakeup.PayFlow {
        payFlowName = "AliGameAppPayFlow"

        /** 重载支付网络请求 */
        payNetClient = new AliGamePayRequests()
    ...
    payFlowManager.registerPayFlow("AliGameAppPayFlow", PayFlow)
}
