...
namespace AppShare.PayFlow.IosPayFlow {
    ...
    export class IosPayRequests extends GDK.PayFlow.PayRequestsNormal {
        ...
        orderCheckOrderState(
            ...
            let path = "order/apple/synchronizeAppleOrder"
            this.client.request(path, data, (data) => {
    ...
    export class PayFlow extends GDK.PayFlow.PayInsideLocalV2.PayFlow {
        payFlowName = "IosPayFlow"

        /** 重载支付网络请求 */
        payNetClient = new IosPayRequests()
    ...
    payFlowManager.registerPayFlow("IosPayFlow", PayFlow)
}
