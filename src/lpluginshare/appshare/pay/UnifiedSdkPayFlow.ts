...
namespace AppShare.PayFlow.UnifiedSdkPayFlow {
    ...
    export class UnifiedPayRequests extends GDK.PayFlow.PayRequestsNormal {
	 ...
	 */
    export class PayFlow extends GDK.PayFlow.PayInAppWithAutoMakeup.PayFlow {
        payFlowName = "UnifiedSdkPayFlow"

        /** 重载支付网络请求 */
        payNetClient = new UnifiedPayRequests()
        ...
        protected wrapPayAPICallParams(config: PaymentParams, orderInfo: CustomNetOrderInfo): GDK.PayItemInfo {
            ...
            let extraStr = JSON.stringify({ outTradeNo: orderInfo.outTradeNo })
    ...
    payFlowManager.registerPayFlow("UnifiedSdkPayFlow", PayFlow)
}
