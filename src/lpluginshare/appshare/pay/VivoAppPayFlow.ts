...
namespace AppShare.PayFlow.VivoAppPayFlow {
    ...
    export class VivoAppPayRequests extends GDK.PayFlow.PayRequestsNormal {
    ...
    export class PayFlow extends GDK.PayFlow.PayInApp.PayFlow {
        payFlowName = "VivoAppPayFlow"

        /** 重载支付网络请求 */
        payNetClient = new VivoAppPayRequests()
    ...
    payFlowManager.registerPayFlow("VivoAppPayFlow", PayFlow)
}
