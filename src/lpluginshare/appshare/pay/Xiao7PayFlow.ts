...
namespace AppShare.PayFlow.Xiao7PayFlow {
    ...
    export class Xiao7PayRequests extends GDK.PayFlow.PayRequestsNormal {
    ...
    export class PayFlow extends GDK.PayFlow.PayInAppWithAutoMakeup.PayFlow {
        payFlowName = "Xiao7PayFlow"

        /** 重载支付网络请求 */
        payNetClient = new Xiao7PayRequests()
    ...
    payFlowManager.registerPayFlow("Xiao7PayFlow", PayFlow)
}
