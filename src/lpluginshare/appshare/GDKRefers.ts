...
namespace AppShare.PayFlow {
	...
	export type PayFlowStatus = GDK.PayFlow.PayFlowStatus
	export type Parent = GDK.PayFlow.Parent
	export type PayWay = GDK.PayFlow.PayWay
	export const PayInApp = GDK.PayFlow.PayInApp
	export const PayInAppWithAutoMakeup = GDK.PayFlow.PayInAppWithAutoMakeup
	export const PayInsideLocalV2 = GDK.PayFlow.PayInsideLocalV2
	...
	export type MakeupOrdersResult = GDK.PayFlow.MakeupOrdersResult
