...
namespace AppShare.PayFlow.MeituAppPayFlow {
    ...
    export class MeituPayRequests extends GDK.PayFlow.PayRequestsNormal {
    ...
    export class PayFlow extends GDK.PayFlow.PayInApp.PayFlow {
        payFlowName = "MeituAppPayFlow"

        /** 重载支付网络请求 */
        payNetClient = new MeituPayRequests()
    ...
    payFlowManager.registerPayFlow("MeituAppPayFlow", PayFlow)
}
